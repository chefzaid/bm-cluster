...
SPEC = importlib.util.spec_from_file_location('fencing', ROOT/'k8s/files/fence-unresponsive-nodes.py')
...
class ChartTests(unittest.TestCase):
    def test_opt_in_and_least_privilege_resources(self):
        ...
        self.assertEqual(script.rstrip(), (ROOT/'k8s/files/fence-unresponsive-nodes.py').read_text().rstrip())
