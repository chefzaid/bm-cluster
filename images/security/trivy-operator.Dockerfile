...
RUN go test -p 2 ./pkg/vulnerabilityreport ./pkg/policy ./pkg/operator/workload \
    && go build -p 2 -trimpath -ldflags="-s -w -X main.version=0.34.0-platform.2 -X main.commit=7107830178ae50e96e9f09d98976e51e6152759f" -o /out/trivy-operator ./cmd/trivy-operator
